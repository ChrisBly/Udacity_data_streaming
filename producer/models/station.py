...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        # replicas
        # topic naming convention from readme.md file - 
        # A topic is created for each station in Kafka to track the arrival events
        topic_name = f"station_arrival_events.{station_name}" # TODO: Come up with a better topic name
        super().__init__(
            topic_name,
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        # Reference" https://knowledge.udacity.com/questions/415994
        # https://knowledge.udacity.com/questions/304390
        # https://knowledge.udacity.com/questions/513460
        # logger.info("arrival kafka integration incomplete - skipping")
        # error running sim.  station_id not defined.
        # Arvo schema 409 error: https://knowledge.udacity.com/questions/114929
        # https://knowledge.udacity.com/questions/597056
        # TypeError: an integer is required on field prev_station_id
